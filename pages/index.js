        ...
        <div className="our-expertise__services-item">
          <div className="our-expertise__services-item-icon">
            <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd" d="M46.6578 35.8298V5.84229H3.34063V35.8298H24.1656V42.4938H18.3344V44.1595H31.6625V42.4938H25.8313V35.8298H46.6562H46.6578ZM5.00781 7.50635H44.9922V34.1626H5.00781V7.50635Z" fill="#00B2A0" />
            </svg>
          </div>
          <div>
            <h3 className="our-expertise__services-item-header m-0">
    ...
    <section className="vision">
      ...
      <div className="vision__content">
        ...
        <p className="vision__description">
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Libero veniam odio itaque. Molestiae aut dicta accusantium quod,
          modi ad alias enim dolor delectus iusto! Inventore tempora labore nobis doloribus optio nulla sit corrupti nostrum,
          tempore debitis pariatur minus maiores velit, autem ex eum distinctio error fugit. Itaque voluptatum quam veritatis
          fuga impedit nulla dolor.
        </p>
        <p>
