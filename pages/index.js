const Index = () => (
  <>
    ...
    <section className="corousel">
      <button type="button" className="corousel__control">
      ...
      <div className="corousel__slide">
        <div className="corousel__slide-content">
          <h3 className="corousel__slide-content-header">
            Then they show that show to the people who make shows
          </h3>
          <p className="corousel__slide-content-description">
        ...
        <div className="corousel__pagination">
          <button type="button" className="corousel__pagination-control" />
          <button type="button" className="corousel__pagination-control" />
          <button type="button" className="corousel__pagination-control corousel__pagination-control--active" />
          <button type="button" className="corousel__pagination-control" />
          <button type="button" className="corousel__pagination-control" />
          <button type="button" className="corousel__pagination-control" />
        </div>
      ...
      <div className="our-team__member-items">
        <div className="our-team__member">
          <img
            ...
            className="out-team__member-photo"
            alt="Bernard Sparks"
          />
